...
namespace Checkpoint2DotNet_Biblioteca.Controllers
{
    public class EnderecosController : Controller
    {
        ...
        public EnderecosController(FiapDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EnderecoId,CEP,Numero,Complemento")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnderecoId,CEP,Numero,Complemento")] Endereco endereco)
        {
