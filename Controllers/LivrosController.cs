...
namespace Checkpoint2DotNet_Biblioteca.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public LivrosController(FiapDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LivroId,Titulo,Genero,DataLancamento")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LivroId,Titulo,Genero,DataLancamento")] Livro livro)
        {
            if (id != livro.LivroId)
            {
                return NotFound();
